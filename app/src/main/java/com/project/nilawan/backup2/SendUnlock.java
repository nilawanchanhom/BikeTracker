...
public class SendUnlock extends Activity {

    String id = "1";
    String sys = "0";

    private static final String TAG = "SendUnlock.java";
    ...
    public void setup() {
        ...
        //Intent inte = new Intent(SendUnlock.this, Notification.class);
       // startActivity(inte);
        Intent abc = new Intent (SendUnlock.this, CheckNoti.class);
        startActivity(abc);
    }
